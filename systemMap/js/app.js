var APP = {
  Player: function () {
    ...
    this.load = function (json) {
      ...
      var scriptWrapParams = "player,renderer,scene,camera,outlinePass";
      ...
      for (var uuid in json.scripts) {
        ...
        for (var i = 0; i < scripts.length; i++) {
          ...
          ).bind(object)(this, renderer, scene, camera, outlinePass);
    ...
    function setComposer() {
      ...
      outlinePass.visibleEdgeColor.set("#4ac925"); // set basic edge color
      outlinePass.hiddenEdgeColor.set("#256412"); // set edge color when it hidden by other objects
